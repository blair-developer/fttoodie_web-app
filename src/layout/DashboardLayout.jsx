...
const DashboardLayout = () => {
  ...
  <div className="drawer-content flex flex-col sm:items-start sm:justify-start">
   ...
   <label htmlFor="my-drawer-2" className="btn btn-primary drawer-button lg:hidden"><MdDashboardCustomize />
</label>
<button className='btn rounded-full px-6 bg-green flex items-center gap-2text-white sm:hidden'>
  <FaRegUser/> Logout
  </button>
   </div>
  ...
  <div className="drawer-side">
    ...
    <ul className="menu p-4 w-80 min-h-full bg-base-200 text-base-content">
      ...
      <li>
        <Link to="/dashboard"><FaBagShopping />Manage Bookings</Link>
      </li>
      <li>
